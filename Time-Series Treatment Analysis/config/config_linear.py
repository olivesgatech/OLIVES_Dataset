...
def parse_option():
    ...
    parser.add_argument('--results_dir', type=str, default='/home/kiran/Desktop/Dev/NeurIPS_2022_Dataset/results.txt')
    ...
    parser.add_argument('--dataset', type=str, default='Prime',
                        choices=['OCT','Biomarker','Prime','Fundus_Treatment','OCT_3D','Fundus_Time_Series','OCT_3D_Time_Series'], help='dataset')
    ...
    if opt.dataset == 'Fundus_Treatment' or opt.dataset == 'OCT_3D' or opt.dataset == 'Fundus_Time_Series' or opt.dataset == 'OCT_3D_Time_Series':
        opt.n_cls = 2
