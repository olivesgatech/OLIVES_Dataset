...
parser.add_argument('--which_baseline', type=str, default='img_only', choices=['img_only', 'att_only', 'img_att'])
...
if __name__ == '__main__':
    ...
    BestStandardClassifier = '../Checkpoints/RCT_Baseline_Jun08_123933'
